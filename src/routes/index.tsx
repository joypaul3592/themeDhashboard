...
// Product
const ProductApp = React.lazy(() => import("../pages/apps/Products/"));
// Product

// Product
const AddProductApp = React.lazy(() => import("../pages/apps/AddProducts/"));
// Product

// Attributes
const AttributesApp = React.lazy(() => import("../pages/apps/Attributes/"));
// Attributes

// Brands
const BrandsApp = React.lazy(() => import("../pages/apps/Brands/"));
// Brands

// Categorie
const CategoriesApp = React.lazy(() => import("../pages/apps/Categories/"));
// Categorie

// Tags
const TagsApp = React.lazy(() => import("../pages/apps/Tags/"));
// Tags

// Uploaded File
const UploadedFileApp = React.lazy(() => import("../pages/apps/UploadedFile/"));
// Uploaded File
...
// Users
const UsersApp = React.lazy(() => import("../pages/apps/Users/"));
// Users

// Withdrawales
const WithdrawalsApp = React.lazy(() => import("../pages/apps/Withdrawals/"));
// Withdrawales

// Settings
const SettingsApp = React.lazy(() => import("../pages/apps/Settings/"));
// Settting
...
const AddProductsAppRoutes: RoutesProps = {
...
const AttributesAppRoutes: RoutesProps = {
  path: "/apps/attributes",
  name: "Attributes",
  route: PrivateRoute,
  roles: ["Admin"],
  icon: "message-square",
  element: <AttributesApp />,
};
const BrandsAppRoutes: RoutesProps = {
  path: "/apps/brands",
  name: "Brands",
  route: PrivateRoute,
  roles: ["Admin"],
...
const CategoriesAppRoutes: RoutesProps = {
...
const TagsAppRoutes: RoutesProps = {
  path: "/apps/tags",
  name: "Tags",
  route: PrivateRoute,
  roles: ["Admin"],
...
const UploadedFileAppRoutes: RoutesProps = {
  path: "/apps/uploadedFile",
  name: "Uploaded File",
  route: PrivateRoute,
  roles: ["Admin"],
  icon: "message-square",
  element: <UploadedFileApp />,
};
...
const WithdrawalsAppRoutes: RoutesProps = {
  path: "/apps/withdrawals",
  name: "Withdrawals",
  route: PrivateRoute,
  roles: ["Admin"],
  icon: "message-square",
  element: <WithdrawalsApp />,
};
...
const appRoutes = [
  ...
  chatAppRoutes,
  ProductsAppRoutes,
  AddProductsAppRoutes,
  AttributesAppRoutes,
  BrandsAppRoutes,
  CategoriesAppRoutes,
  TagsAppRoutes,
  UploadedFileAppRoutes,
  OrdersAppRoutes,
  UsersAppRoutes,
  WithdrawalsAppRoutes,
  SettingsAppRoutes,
  emailAppRoutes,
  projectAppRoutes,
  taskAppRoutes,
