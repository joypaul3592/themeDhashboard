...
const styles: CSSProperties = { paddingBottom: "15px" };
      ...
      >
        <div className="d-flex align-items-center ">
          ...
          <input
            ...
            placeholder={`Type your ${nameFor}`}
            className="form-control w-auto ms-1"
          />
        </div>
        <div>
          All {nameFor} : <span className=" fw-bold">{`${count}`}</span>
        </div>
      </span>
    </div>
  );
    ...
    <>
      ...
      <div className="table-responsive">
        ...
        >
          ...
          <tbody className=" bg" {...dataTable.getTableBodyProps()}>
